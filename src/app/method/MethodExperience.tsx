        ...
        */}
        <section
          ...
          style={{
            ...
            /*
              25 אחוז ולא מרכז. הצילום אנכי והכרטיס רחב ונמוך, ולכן חיתוך
              במרכז היה נוחת על המכנסיים והרצפה. הגובה הזה מביא את שתי
              הטבעות ואת פלג הגוף העליון אל תוך הפריים.

              הצילום עצמו הוחלף. הקודם הראה רגליים ומרצפות, וצריך היה
              לחפש בו טבעת אחת. הוא גם היה מחצר אחרת מזו שבצילום של מסך
              הבית, ושני מקומות בשני מסכים נקראים כשתי אפליקציות.

              שלושים ושמונה פריימים נבדקו לפני הבחירה הזאת. שלוש בדיקות
              נכשלו בדרך ושוות רישום: זום פנימה מגדיל טורסו ומאבד את
              הטבעת, הזזה אופקית לא עושה כלום כי הכרטיס מציג את כל רוחב
              הפריים ממילא, וטבעת שנופלת בצד ימין נבלעת בצעיף שאטום שם
              ב-0.95 בשביל הכותרת. מכאן שהטבעות חייבות לשבת בשליש השמאלי,
              וזה מה שמסנן פריים.
            */
            ...
            style={{
              ...
              */
              /*
                ...
                שתי גרסאות נפסלו כאן. הראשונה הייתה מילוי חום שטוח, והוא
                עבד כל עוד הוא היה הדבר החם היחיד במסך. ברגע שכרטיס
                הפתיח קיבל צילום אמיתי הוא נקרא כחיקוי שלו. השנייה ניסתה
                טקסטורת עץ אמיתית, אבל wood-band.jpg הוא רצועה של 1000
                על 172 שנוצרה לכפתור: מתיחה שלה על כרטיס גבוה מגדילה את
                הסיב פי שניים וחותכת חמישית מהרוחב, וזה נראה מזויף עוד
                יותר מהמילוי השטוח.

                הכלל הוא אחד למסך: משטח חם הוא הדגשה. כאן הצילום שמעל
              ...
              return visibleRules.map((rule, index) => (
                ...
                >
                  ...
                  {/*
                    ...
                    היא יושבת בקצה הפותח של השורה, כלומר מימין, ובעברית
                    זה המקום שהעין מתחילה בו. ספרה בקצה הסוגר נקראת
                    כקישוט בסוף שורה ולא כמספר שלה.

                    זה נכשל פעם אחת: הספרה ישבה מתחת למילים ונחתכה בחצי
                    על גבול הכרטיס. מה שחסר היה מרווח, לא צד אחר. הטקסט
                    מוזז שמאלה בריפוד משלו, והספרה מקבלת את הטור שנפתח.
                  ...
                  */}
                  ...
                  {/* הריפוד פותח לספרה טור משלה. רוחב קבוע לספרה ולא רק
                      מרווח, אחרת ארבע השורות מתחילות בארבעה מקומות. */}
                  <div className="relative ps-[3.6rem]">
