...
export default function WorkoutRunner({
  ...
  */
  ...
  /**
   * מביא את ההדגמה של התרגיל הבא כבר בזמן המנוחה.
   *
   * למה זה נדרש: אחרי המעבר ל-1080 קליפ טיפוסי שוקל כשמונה מגה ורץ
   * בכ-4.6 מגהביט. על סלולרי חלש זה גם נטען לאט וגם לא מדביק את קצב
   * הניגון, כלומר ההדגמה מגמגמת בדיוק כשהמתאמן מסתכל עליה. הורדת
   * האיכות לא באה בחשבון, ולכן מסתירים את ההמתנה במקום לקצר אותה.
   *
   * המנוחה היא החלון המושלם: שישים שניות שבהן לא קורה כלום ברשת,
                  ...
                  >
                    {w.posterUrl ? (
                      ...
                      <img
                        ...
                        alt=""
                        /*
                          טעינה עצלה, וכאן היא משמעותית.

                          התמונה הזאת מוצגת כריבוע של 54 פיקסלים, אבל
                          הקובץ עצמו הוא הפוסטר המלא ברוחב 1080 — אותו
                          קובץ בדיוק שמשמש כתמונת הפתיחה של הנגן במסך
                          האימון, שם הרוחב המלא נחוץ. גרסה שנייה קטנה
                          הייתה מכפילה אחסון וצינור בשביל תמונה שנעלמת
                          בשנייה, ולכן מגישים אחת.

                          המחיר: רשימת חימום עם שישה תרגילים מושכת קרוב
                          למגה. נמדד ב-20 באוגוסט 2026, כ-230KB לתמונה.
                          עם lazy מי שלא גולל למטה לא משלם על מה שלא ראה,
                          וזה בדיוק המצב בחצר עם רשת סלולרית חלשה.
                        */
                        loading="lazy"
                        decoding="async"
