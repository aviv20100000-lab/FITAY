...
/**
 * האימונים האחרונים. המקטע ישב בתחתית הדף כתיעוד שקט, וב-19 באוגוסט
 * 2026, כשירדו "אז והיום" ו"תרגילים שעלו דרגה", הוא עלה אל מיד אחרי
 * לוח הספירה.
 *
 * המקטע נשאר קצר בכוונה. חמישה אימונים
...
export default function RecentWorkouts({ rows }: { rows: RecentRow[] }) {
  ...
  return (
    <>
      {/*
        בלי כרטיס, כמו הלוח. מקטעי התיעוד חולקים שפה אחת: כותרת
        שקטה, ואז שורות על הדף עם קו מפריד דק.
      */}
      <div>
        {shown.map((row, i) => {
          const body = (
