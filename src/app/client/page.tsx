    ...
    for (const p of programs.rows) {
      ...
      return {
        ...
        /*
          ...
          קודם הוא הופיע רק כשהמתאמן בחר אימון שאינו של היום, כאישור
          לבחירה. אבל השאלה "איזה אימון אני מתחיל עכשיו" קיימת גם בלי
          בחירה, והשער לא ענה עליה: הוא אמר "אימון 12 מתוך 24", שזה
          מיקום בתוכנית ולא זהות של אימון. את השם המתאמן גילה רק אחרי
          שנכנס.
        */
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                */}
                                ...
                                {/*
                                  ...
                                  גודל, על השורה שאפשר לעבור אליה.
                                  "האימון של היום" ומיד מתחתיו "האימון
                                  השני" נקראים כזוג, ומזה מובן שיש שניים
                                  ושאפשר לגעת בשני.

                                  אביב בחר את הניסוח הזה ב-19 באוגוסט
                                  2026 מתוך כמה חלופות. הוא עובדתי ומקביל
                                  לתווית שלידו, ולא הוראת הפעלה: משפט
                                  שמצווה על המתאמן מה לעשות נקרא כהנחיה
                                  של האפליקציה, וכאן הבחירה שלו.
                                */}
