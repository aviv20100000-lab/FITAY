              ...
              */}
              <div
                ...
                style={{
                  ...
                  /*
                    50 אחוז: שתי הטבעות שלמות והידיים אוחזות בהן.

                    קודם עמד כאן 62, ובגובה הזה הטבעת העליונה נחתכה
                    בדיוק בקצה העליון של הכרטיס: נשארה ממנה חצי קשת,
                    ומה שקרא בבירור היה הזרועות והמאוורר שברקע. הפס
                    הזה נמוך מאוד ביחס לרוחבו, ולכן כל אחוז כאן שווה
                    הרבה.

                    ארבעים פריימים מ-videos-web נבדקו כתחליף לתמונה
                    עצמה, ואף אחד לא ניצח אותה בפס בפרופורציה הזאת.
                    ההפרש כולו היה בגובה החיתוך.

                    נוסה גם פריים אחר עם רקע נקי יותר, ואביב העדיף את
                    זה. הרקע כאן עמוס יותר, אבל התנוחה קריאה ומיידית
                    וזה מה שהכריע.
                  */
