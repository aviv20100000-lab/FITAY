/**
 * התוכניות לפי הרשימה שנמסרה מ-FITAY.
 *
 ...
 *   • שלוש רמות. "שלב" ב-FITAY הוא רמת קושי.
 *   • בכל רמה שני אימונים, משיכה ודחיפה. אין אימון סיבולת.
 *   • רמה 3 היא תוכנית סקילים אחת, שמבוצעת יום כן יום לא.
 *   • רמה היא 24 אימונים, וצריך אישור מאמן כדי לעבור לבאה.
 *
 * המספרים: FITAY נתנו טווחים והבהירו שהמבנה בסיסי וניתן לשינוי. הערכים כאן
...
export const ITAY_TEMPLATES: ItayTemplate[] = [
  ...
  },
  {
    ...
    title: "רמה 2 · התקדמות",
    description:
      "אותו מבנה, עם תרגילים קשים יותר. נוספים תרגילים ביד אחת ותרגילים לחגורת הכתפיים. עוברים לכאן רק אחרי שרמה 1 יציבה.",
    level: 2,
    weeks: 6,
    workouts: [
      {
