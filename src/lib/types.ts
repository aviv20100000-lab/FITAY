...
/**
 * מה המתאמן עשה בתרגיל הזה בפעם הקודמת.
 *
 * לא מוצג לו במסך האימון: הכרטיס שהציג את זה ירד. הנתונים מזינים את
 * היעד של היום ואת ההשוואה במסך הסיום.
 *
 * banded נשמר לכל סט בנפרד, כי אפשר להתחיל סט עם גומייה ולסיים בלעדיה.
 * anyBanded מסכם אם הפעם הקודמת נעזרה בגומייה בכלל, ולפיו מוכרעת השאלה
 * אם ההשוואה בכלל הוגנת: סט עם גומייה אינו אותו הישג כמו סט בלעדיה.
 */
/**
