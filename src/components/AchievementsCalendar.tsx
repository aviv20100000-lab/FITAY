          ...
          return (
            <span
              ...
              style={{
                ...
                // פשוט לא מצוירת.
                //
                // המילוי עומעם. קודם הוא היה wood-2 מלא, כלומר עשרה
                // ריבועי זהב אטומים, והם היו הדבר הכבד ביותר בעמוד:
                // כבדים מהמונה שבראש, שהוא ההישג, וכבדים מהתרגילים
                // שעלו דרגה. לוח הנוכחות הוא תיעוד ולא הגיבור, ובעוצמה
                // ההיא הוא הפך את סדר הקריאה של הלשונית.
                //
                // המספר עצמו נשאר בגוון העץ הבהיר ובמשקל מלא, כך שיום
                // שהתאמנת בו עדיין קופץ מיד. מה שירד הוא רק צעקת הרקע.
                background: isDone ? "var(--wood-wash-active)" : "transparent",
                color: isDone ? "var(--wood-1)" : "var(--faint)",
              }}
            >
              {day.number}
            </span>
