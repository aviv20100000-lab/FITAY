...
/**
 * העלאת סרטון לכל אחד מארבעת התרגילים הראשונים בתוכנית.
 *
 * נפתח רק אחרי שהמתאמן השלים את כל האימונים, ומצורף לבקשת המעבר לרמה
 * הבאה. העלאה אחת בכל פעם ולא ארבע בסוף: מתאמן ברשת סלולרית שמעלה ארבעה
 * קליפים ברצף מסתכל על מסך שנראה תקוע, ויוצא ממנו באמצע.
 */
